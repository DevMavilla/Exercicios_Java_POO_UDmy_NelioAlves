...
public class ListFormules {
    public static void main(String[] args){
        ...
        //Primeiro converte para Stream* - faz a operação filtro com expressão Lambda que precisar .filter(...)
        // - Depois converter para lista collect(c.Tolist()).../
        ...
        // ENCONTRA ELEMENTO COM PREDICADO X : PRIMEIRO ELEMENTO COM A LETRA A FindFirst ou null (orElse)
        // ENCONTRA O ELEMENTO
